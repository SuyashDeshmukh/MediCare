...
/*
    Adapter for Navigation Drawer Activity Custom Listview to display all the
    added medication with respective details like dosage amount, name and next reminder time.
